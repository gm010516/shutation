...
public final class ActivityMapBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton GetOffPlus;
  ...
  private ActivityMapBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton GetOffPlus,
      @NonNull ImageView imageView2, @NonNull TextView textView) {
    this.rootView = rootView;
    this.GetOffPlus = GetOffPlus;
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.GetOffPlus;
      ImageButton GetOffPlus = ViewBindings.findChildViewById(rootView, id);
      if (GetOffPlus == null) {
        break missingId;
      }
      ...
      return new ActivityMapBinding((ConstraintLayout) rootView, GetOffPlus, imageView2, textView);
    }
